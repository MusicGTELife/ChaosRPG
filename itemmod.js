...
ItemModTable.INT = _(
    ...
    [ { 'id': StatTable.INT.id, 'min_value': 3, 'max_value': 6 } ]
)
ItemModTable.DEX = _(
    0x0002, 'dexterity', ItemModClass.MINOR.id,
    [ { 'id': StatTable.DEX.id, 'min_value': 3, 'max_value': 6 } ]
)
ItemModTable.STR = _(
    0x0003, 'strength', ItemModClass.MINOR.id,
    [ { 'id': StatTable.STR.id, 'min_value': 3, 'max_value': 6 } ]
)
ItemModTable.VIT = _(
    0x0004, 'vitality', ItemModClass.MINOR.id,
    [ { 'id': StatTable.VIT.id, 'min_value': 3, 'max_value': 6 } ]
)
...
ItemModTable.ATK = _(
    ...
    [ { 'id': StatTable.ATK.id, 'min_value': 4, 'max_value': 10 } ]
)
ItemModTable.MATK = _(
    0x0101, 'force', ItemModClass.MINOR.id,
    [ { 'id': StatTable.MATK.id, 'min_value': 4, 'max_value': 10 } ]
)
ItemModTable.DEF = _(
    0x0102, 'defense', ItemModClass.MINOR.id,
    [ { 'id': StatTable.DEF.id, 'min_value': 4, 'max_value': 10 } ]
)
ItemModTable.MDEF = _(
    0x0103, 'resistance', ItemModClass.MINOR.id,
    [ { 'id': StatTable.MDEF.id, 'min_value': 4, 'max_value': 10 } ]
)

ItemModTable.HP = _(
    0x0110, 'hit points', ItemModClass.MINOR.id,
    [ { 'id': StatTable.HP.id, 'min_value': 5, 'max_value': 15 } ]
)
...
ItemModTable.REACTION = _(
    ...
    [ { 'id': StatTable.REACTION.id, 'min_value': 2, 'max_value': 10 } ]
)
