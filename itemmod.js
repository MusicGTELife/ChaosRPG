...
ItemModTable.INT = _(
    ...
    [ { id: StatTable.INT.id, min_value: 1, max_value: 3 } ]
)
ItemModTable.DEX = _(
    0x0002, "dexterity", ItemModClass.MINOR.id,
    [ { id: StatTable.DEX.id, min_value: 1, max_value: 3 } ]
)
ItemModTable.STR = _(
    0x0003, "strength", ItemModClass.MINOR.id,
    [ { id: StatTable.STR.id, min_value: 1, max_value: 3 } ]
)
ItemModTable.VIT = _(
    0x0004, "vitality", ItemModClass.MINOR.id,
    [ { id: StatTable.VIT.id, min_value: 1, max_value: 3 } ]
)
