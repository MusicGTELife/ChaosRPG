...
// Armor
ItemTable.GREAT_HELM = _(0x0001, "Great Helmet", SF.INVENTORY|SF.HEAD, IC.ARMOR, AC.HELMET,
    [ CR(ST.DEX.id, 3), CR(ST.STR.id, 4) ]
)
ItemTable.FACE_MASK = _(0x0002, "Mask", SF.INVENTORY|SF.HEAD, IC.ARMOR, AC.HELMET,
    [ CR(ST.DEX.id, 2), CR(ST.STR.id, 3) ]
)
ItemTable.LIGHT_GLOVES = _(0x0100, "Light Gloves", SF.INVENTORY|SF.HANDS, IC.ARMOR, AC.GLOVES,
    [ CR(ST.STR.id, 1), CR(ST.DEX.id, 2) ]
)
ItemTable.SMALL_SHIELD = _(0x0800, "Small Shield", SF.INVENTORY|SF.ARM, IC.ARMOR, AC.SHIELD,
