...
MonsterTable.GOBLIN = _(
    0x0001, 'Goblin', MC.BEAST, BeastClass.MAMMAL, WF.MELEE_1H, 30, [
...
MonsterTable.SKELETON_WARRIOR = _(
    0x0100, 'Skeleton Warrior', MC.UNDEAD, UndeadClass.SKELETON, WF.ANY_MELEE, 40, [
...
MonsterTable.SKELETON_ARCHER = _(
    0x0101, 'Skeleton Archer', MC.UNDEAD, UndeadClass.SKELETON, WF.RANGED, 40, [
    { id: ST.DEX.id, value: 4 },
    { id: ST.INT.id, value: 2 },
    { id: ST.STR.id, value: 4 },
    { id: ST.VIT.id, value: 3 },
...
MonsterTable.SKELETON_MAGE = _(
    0x0102, 'Skeleton Mage', MC.UNDEAD, UndeadClass.SKELETON, WF.CASTING_1H, 40, [
...
MonsterTable.GIANT = _(
    0x0200, 'Giant', MC.HUMANOID, HumanoidClass.DARKSWORN, WF.MELEE_2H, 50, [
    { id: ST.DEX.id, value: 3 },
    { id: ST.INT.id, value: 2 },
    { id: ST.STR.id, value: 4 },
    { id: ST.VIT.id, value: 4 },
